    ...
    <div class="box-body">
        <div class="row">
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[0]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[0]->indicator }}"
                        number="{{ $map[0]->number }}"
                        data-toggle="modal" data-target="#QuickInfo"
                        class="number showQuickInfo">{{ $map[0]->number }}</a></p>
            ...
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[1]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[1]->indicator }}"
                        number="{{ $map[1]->number }}"
                        data-toggle="modal" data-target="#QuickInfo"
                        class="number showQuickInfo">{{ $map[1]->number }}</a></p>
            ...
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[2]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[2]->indicator }}"
                        number="{{ $map[2]->number }}"
                        data-toggle="modal" data-target="#QuickInfo"
        ...
        <div class="row">
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[3]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[3]->indicator }}"
                        number="{{ $map[3]->number }}"
                        data-toggle="modal" data-target="#QuickInfo"
            ...
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[4]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[4]->indicator }}"
                        number="{{ $map[4]->number }}"
                        data-toggle="modal" data-target="#QuickInfo"
            ...
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[5]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[5]->indicator }}"
                        number="{{ $map[5]->number }}"
                        data-toggle="modal" data-target="#QuickInfo"
        ...
        <div class="row">
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[6]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[6]->indicator }}"
                        number="{{ $map[6]->number }}"
                        data-toggle="modal" data-target="#QuickInfo"
            ...
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[7]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[7]->indicator }}"
                        number="{{ $map[7]->number }}"
                        data-toggle="modal" data-target="#QuickInfo"
            ...
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[8]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[8]->indicator }}"
                        number="{{ $map[8]->number }}"
                        data-toggle="modal" data-target="#QuickInfo"
        ...
        <div class="row">
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[9]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p class="number">
            ...
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[10]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[10]->indicator }}"
            ...
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[11]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p><a indicator="{{ $map[11]->indicator }}"
        ...
        <div class="row">
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[12]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p class="number">
            ...
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[13]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p class="number">
            ...
            <div class="col col-lg-4 col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[14]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <div class="box-body text-center">
                    <p class="number">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col col-lg-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h4 class="text-center">Chỉ Số {{ Indicator::where(['code' => $map[15]->indicator])->first()->name }}</h4>
                    </div>
                </div>
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach($map[15]->number as $year => $months)
                        <tr>
                            <th scope="row">
                                <a indicator="{{ $map[15]->indicator }}"
                                    number="{{ $year }}"
                                    data-toggle="modal" data-target="#QuickInfo"
